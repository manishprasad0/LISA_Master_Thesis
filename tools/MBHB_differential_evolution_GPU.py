...
class MBHB_finder_time_frequency:
    ...
    def get_stft_of_data(self, include_sens_kwargs=False):
        f, t, Zxx_data_A = signal.stft(self.data_t[0], fs=1/self.dt_full, nperseg=self.nperseg, noverlap=0)
        f, t, Zxx_data_E = signal.stft(self.data_t[1], fs=1/self.dt_full, nperseg=self.nperseg, noverlap=0)
    ...
    def calculate_amplitude(self, parameters_11: Any):
        ...
        parameters_bbhx = parameters_bbhx.get()
        ...
        Zxx_temp_A = signal.stft(template_t[0], fs=1/self.dt, nperseg=self.nperseg, noverlap=0)[2]
        Zxx_temp_E = signal.stft(template_t[1], fs=1/self.dt, nperseg=self.nperseg, noverlap=0)[2]
